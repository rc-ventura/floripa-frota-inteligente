...
1. **Given** placas grafadas como `ABC-1234`, `abc1234` e `ABC 1234` em fontes distintas, **When** transformadas, **Then** todas viram `ABC1234` e reconciliam no mesmo veículo.
...
- **FR-003**: A transformação MUST normalizar placa para o canônico `AAA9999`, interpretar datas em múltiplos formatos (incluindo serial de planilha), converter decimais com vírgula e padronizar vocabulário de tipos de manutenção.
...
- Arquitetura: `wiki/arquitetura_tecnica_desafio13_v1.md` (seções 3, 8 e 9)
